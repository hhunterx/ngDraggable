...
angular.module("ngDraggable", [])
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                //  return;
                var offset, _mx, _my, _tx, _ty, stx, sty;
                ...
                var onlongpress = function(evt) {
                    ...
                    stx = _mx - _tx;
                    sty = _my - _ty;
                    //console.log({ x: _mx, y: _my, tx: _tx, ty: _ty});
                    moveElement(_tx, _ty, "ok");
                ...
                var reset = function() {
                    element.css({ left: '', top: '', width: '', position: '', 'z-index': '' });
                };
